...
},{"../templates/SteroidsConnectTemplates":36,"./connect-ui":2,"./generators":6,"./logs":11,"./navigation-and-themes":24,"./preview":34}],4:[function(_dereq_,module,exports){
"use strict";
module.exports = [
  function() {
    return {
...
},{"./GeneratorsAPI":4,"./generatorsViewDirective":5}],7:[function(_dereq_,module,exports){
"use strict";
module.exports = [
...
},{"./../preview":34,"./LogCloudConnectorService":7,"./LogsAPI":8,"./LogsFilterAPI":9,"./filterUnique":10,"./logDateFormatFilter":12,"./logFiltersViewDirective":13,"./logMessageDirective":14,"./logTimeFormatFilter":15,"./logTimeMillisecondsFormatFilter":16,"./logViewDirective":17}],12:[function(_dereq_,module,exports){
"use strict";
module.exports = [
  function() {
...
},{"./SteroidsSettingsAPI":18,"./TabModalCtrl":19,"./colorInputDirective":20,"./colorpicker":21,"./drawerConfiguratorViewDirective":22,"./generalSettingsConfiguratorViewDirective":23,"./navigationAndThemesViewDirective":25,"./navigationBarConfiguratorViewDirective":26,"./statusBarConfiguratorViewDirective":27,"./stickyScrollDirective":28,"./tabEditorDirective":29,"./tabsConfiguratorViewDirective":30,"./ui-sortable":31,"./viewSelectorDirective":32}],25:[function(_dereq_,module,exports){
"use strict";
module.exports = [
...
"use strict";
module.exports = angular.module("SteroidsConnect.preview", ['ja.qr']).directive("previewView", _dereq_("./previewViewDirective")).factory("DevicesAPI", _dereq_("./DevicesAPI"));


},{"./DevicesAPI":33,"./previewViewDirective":35}],35:[function(_dereq_,module,exports){
"use strict";
module.exports = [
...
angular.module('SteroidsConnect').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('/steroids-connect/preview/preview-view.html',
    ...
    "      <div class=\"row\">\n" +
    "        <div class=\"col-xs-12\">\n" +
    "          <qr text=\"qrCode\" class=\"img-responsive\"></qr>\n" +
    "        </div>\n" +
    "        <div class=\"col-xs-12\">\n" +
